...
<div class="wcp-openweather-default-widget wp-open-weather wpw-widget wcp-openweather-primary-background wcp-openweather-primary-color">
    ...
    <div class="wcp-openweather-content wp-open-weather-data">
        <?php 
            if ( !$hasData ) : 
                echo RPw_Theme::instance()->getTemplate("widget/wcp_weather_widget/nodata");  
            else: 
        ?>
        <div class="wcp-openweather-container">
            ...
            <?php 
                if ( !empty($weather) ) :
                    ...
                    echo RPw_Theme::instance()->getTemplate('widget/wcp_weather_widget/now', $weather); 
                endif;
            ?>        
        </div>
        <?php endif; ?> 
        ...
        <?php 
            if (!empty($forecast)) :
                ...
                echo RPw_Theme::instance()->getTemplate('widget/wcp_weather_widget/forecast', $forecast);
            endif;                
        ?>        
    </div>
</div>
