...
<tr class="wcp-openweather-forecast-item wp-open-weather-forecast-item wp-open-weather-block wcp-openweather-primary-background <?php echo ($index % 2 != 0) ? ' wcp-openweather-forecast-item-light' : '';?>">
    <td class="wcp-openweather-forecast-item-align"><span class="wcp-openweather-forecast-item-day"><?php echo date('D', $item->getDay());?></span> <span class="wcp-openweather-forecast-item-date"><?php echo date('m/d', $item->getDay());?></span></td>
    <td class="wcp-openweather-forecast-item-icon"><div class="wcp-openweather-forecast-day-icon"><?php echo RPw_Theme::instance()->renderIcon( $item ); ?></div></td>
